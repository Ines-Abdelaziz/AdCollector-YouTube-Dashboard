  ...
  return (
    <DefaultLayout>
      ...
      <div className="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
        ...
        <ChartThree title='Google Informations Used To Target You'  data={data? data.googleReasons.targetingReasons.map((reason: { reason: string; occurrences: string; }) => ({
          item: reason.reason,
          count: parseFloat(reason.occurrences)})) : ''} />
        <ChartThree title='Other Informations Used To Target You' data={data? data.targetingReasons.targetingReasons.map((reason: { normalized_reason: string; occurrences: string; }) => ({

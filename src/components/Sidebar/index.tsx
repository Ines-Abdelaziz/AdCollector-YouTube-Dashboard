          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                ...
                <svg className="w-5 h-5 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 22 22">
    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9.5 10a2.5 2.5 0 1 1 5 .2 2.4 2.4 0 0 1-2.5 2.4V14m0 3h0m9-5a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
  </svg>
                  Faq's
                </NavLink>
              </li>
            ...
            {/* Privacy Policy Item */}
                ...
                >
                    ...
                    height="22"
                    viewBox="0 0 22 20"
                    fill="none"><defs></defs><path className="cls-1" d="M5.25,7c0-.414.336-.75.75-.75h7c.414,0,.75.336.75.75s-.336.75-.75.75h-7c-.414,0-.75-.336-.75-.75ZM9,12.25h-3c-.414,0-.75.336-.75.75s.336.75.75.75h3c.414,0,.75-.336.75-.75s-.336-.75-.75-.75ZM6,10.75h7c.414,0,.75-.336.75-.75s-.336-.75-.75-.75h-7c-.414,0-.75.336-.75.75s.336.75.75.75ZM17,13.875c-.414,0-.75.336-.75.75v2c0,.414.336.75.75.75s.75-.336.75-.75v-2c0-.414-.336-.75-.75-.75ZM22.25,16.5c0,2.895-2.355,5.25-5.25,5.25-1.143,0-2.194-.377-3.057-1H5c-1.517,0-2.75-1.233-2.75-2.75V5c0-1.517,1.233-2.75,2.75-2.75h9c1.517,0,2.75,1.233,2.75,2.75v6.275c.085-.004.164-.025.25-.025,2.895,0,5.25,2.355,5.25,5.25ZM5,19.25h7.548c-.497-.802-.798-1.739-.798-2.75,0-2.278,1.468-4.203,3.5-4.927v-6.573c0-.689-.561-1.25-1.25-1.25H5c-.689,0-1.25.561-1.25,1.25v13c0,.689.561,1.25,1.25,1.25ZM20.75,16.5c0-2.067-1.683-3.75-3.75-3.75s-3.75,1.683-3.75,3.75,1.683,3.75,3.75,3.75,3.75-1.683,3.75-3.75ZM17,17.875c-.414,0-.75.336-.75.75s.336.75.75.75.75-.336.75-.75-.336-.75-.75-.75Z"/><text x="0" y="39" fill="#000000" font-size="5px" font-weight="bold" font-family="'Helvetica Neue', Helvetica, Arial-Unicode, Arial, Sans-serif">Created by Saepul Nahwan</text><text x="0" y="44" fill="#000000" font-size="5px" font-weight="bold" font-family="'Helvetica Neue', Helvetica, Arial-Unicode, Arial, Sans-serif">from the Noun Project</text></svg>
